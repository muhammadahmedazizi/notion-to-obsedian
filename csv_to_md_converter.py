    ...
    for file in os.listdir(input_dir):
        if file.endswith(".csv"):
            ...
            try:
                ...
                # Normalize column names (make lowercase and strip spaces)
                df.columns = [col.strip().lower() for col in df.columns]

                # Try to flexibly detect relevant columns
                ...
                parent_url = df[parent_url_col].iloc[0] if parent_url_col else None
